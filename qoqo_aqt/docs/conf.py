...
try:
    with open('../qoqo_aqt/__version__.py') as f:
        lines = f.readlines()
...
man_pages = [
    (master_doc, 'qoqo_aqt', 'qoqo_aqt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'qoqo_aqt', 'qoqo_aqt Documentation',
     author, 'qoqo_aqt', 'AQT backend for qoqo quantum computing toolkit.',
     'Miscellaneous'),
]
